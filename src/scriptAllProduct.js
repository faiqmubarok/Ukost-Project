...
let listGenderSearch = document
  .querySelector("#list-gender")
...
let listGenderSearch2 = document
  .querySelector("#list-gender-2")
  .querySelectorAll("input");
...
let listSearchDefault2 = defaultSearchEngine2.querySelectorAll(
  "ul[list-search] li a",
);
...
function handleProductTypeChange(isSecondForm) {
  let kontrakanChecked =
    this.checked &&
    (isSecondForm ? this.id === "Kontrakan-2" : this.id === "Kontrakan");
  let gender = isSecondForm
    ? document.getElementById("gender-2")
    : document.getElementById("gender");
  let fasilitasUmum = isSecondForm
    ? document.getElementById("fasilitas-umum-2")
    : document.getElementById("fasilitas-umum");
  let fasilitasKamar = isSecondForm
    ? document.getElementById("fasilitas-kamar-2")
    : document.getElementById("fasilitas-kamar");
  let fasilitasBersama = isSecondForm
    ? document.getElementById("fasilitas-bersama-2")
    : document.getElementById("fasilitas-bersama");
  let fasilitasKontrakan = isSecondForm
    ? document.getElementById("fasilitas-kontrakan-2")
    : document.getElementById("fasilitas-kontrakan");
  let jumlahKamar = isSecondForm
    ? document.getElementById("jumlah-kamar-2")
    : document.getElementById("jumlah-kamar");
  let jumlahKamarMandi = isSecondForm
    ? document.getElementById("jumlah-kamar-mandi-2")
    : document.getElementById("jumlah-kamar-mandi");
  let peraturanKost = isSecondForm
    ? document.getElementById("peraturan-kost-2")
    : document.getElementById("peraturan-kost");
  let rangeJudul = isSecondForm
    ? document.getElementById("judul-range-2")
    : document.getElementById("judul-range");
  let rangeKost = isSecondForm
    ? document.getElementById("range-kost-2")
    : document.getElementById("range-kost");
  let rangeKontrakan = isSecondForm
    ? document.getElementById("range-kontrakan-2")
    : document.getElementById("range-kontrakan");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updatePagination() {
    if (currentPage <= Math.floor(paginationDisplayCount / 2) + 1) {
      ...
      currentPage >
      totalPages - Math.floor(paginationDisplayCount / 2)
    ) {
